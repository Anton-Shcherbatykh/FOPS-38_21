...
P.S. Во втором задании разные имена контейнеров из-за того, что словил ошибку при создании первого Deployment, которая выражалась в том, что даже после создания Service и его запуска Pod не стартовал корректно. "Покурил" интернет на предмет исправления, переделал Deployment и всё корректно заработало.
